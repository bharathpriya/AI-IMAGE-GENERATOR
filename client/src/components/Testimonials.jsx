...
const Testimonials = () => {
  return (
    ...
    className='flex flex-col items-center justify-center my-20 p-12'>
      ...
      <p className='text-gray-500 mb-12'>Whta Our Users Are Saying</p>

        <div className='flex flex-wrap gap-6'>
            {testimonialsData.map((testimonialsData, index)=>(

                <div key={index} 
                className='bg-white/20 p-12 rounded-lg shadow-md broder w-80 m-auto cursor-pointer hover:scale-[1.02] transition-all'>
