  ...
  return (
    ...
    >
      ...
      >
        ...
        <p>Best Text To imagex generator</p>
        <img src={assets.star_icon} alt="" />
        </motion.div>

        <motion.h1 className='text-4xl max-w-[300px] sm:text-7xl sm:max-w-[590px] mx-auto 
        mt-10 text-center'>Turn text to<span className='text-blue-600'
        initial={{ opacity:0}}
        animate={{opacity:1}}
        ...
        <motion.p className='text-center max-w-xl mx-auto mt-5'
          ...
          animate={{opacity:1, y: 0}}
        >Unleash your creativity with AI, Turn your imaginnation into visual art in seconds - Just type,and watch the magic happen</motion.p>  
